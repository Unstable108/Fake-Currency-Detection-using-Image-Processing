...
clc;
close all;
Ireal = imread('2000_real.jpeg'); % Real
Ifake = imread('2000_fake.jpeg'); % Fake
[x,y,z] = size(Ireal);
...
croppedImageReal = hsvImageReal(:,y-1660:y-1400,:);
croppedImageFake = hsvImageFake(:,y-1700:y-1360,:);
satThresh = 0.1;
valThresh = 0.9;
